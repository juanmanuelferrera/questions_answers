#!/usr/bin/env python3
"""
Upload conversation verses and chunks to remote D1
Includes book entry, verses, and chunks
"""
...
def main():
    print("=" * 80)
    print("UPLOADING CONVERSATIONS TO REMOTE D1")
    print("=" * 80)
...
VALUES ({chunk_id}, {verse_id}, '{chunk_type}', {chunk_index_str}, {escape_sql_string(content)}, {word_count_str});"""
    ...
    if verse_failed or chunk_failed:
        ...
        print()
        print("✅ All conversations uploaded successfully to remote D1!")
        print("🎉 Conversations are now available in the Book Source dropdown!")

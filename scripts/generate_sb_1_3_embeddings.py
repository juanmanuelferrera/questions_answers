#!/usr/bin/env python3
"""
Generate embeddings for Srimad Bhagavatam Cantos 1-3 chunks
"""
...
def generate_embeddings():
    ...
    print("=" * 80)
    print("GENERATING EMBEDDINGS FOR SRIMAD BHAGAVATAM CANTOS 1-3")
    print("=" * 80)
    ...
    output_file = 'sb_cantos_1_3_embeddings.json'

#!/usr/bin/env python3
"""
Import only KB books (Caitanya Caritamrita) to existing D1 database
...
def main():
    print("=" * 80)
    print("IMPORTING KB BOOKS TO D1")
    print("=" * 80)

    # Load KB book data
    with open('kb_parsed.json', 'r') as f:
        kb_data = json.load(f)
    ...
    # Process each KB book
    for book_code in ['kb']:
        if book_code not in kb_data:
            continue
